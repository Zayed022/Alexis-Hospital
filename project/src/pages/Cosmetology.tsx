  ...
  return (
    <div className="min-h-screen bg-white pt-20">
      <motion.section
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="relative py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#F7C6D3]/20 via-white to-[#A7D3F3]/20"
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <motion.span
                ...
                className="bg-gradient-to-r from-[#F7C6D3] to-[#A7D3F3] text-white px-4 py-2 rounded-full text-sm font-medium"
              >
                Premium Cosmetology
              </motion.span>
              <h1 className="text-5xl md:text-6xl font-bold text-gray-800 mt-6 mb-6">
                Advanced{' '}
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                ...
                expert dermatologists, and personalized treatment plans designed to
              ...
              <Link to="/booking">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="bg-gradient-to-r from-[#F7C6D3] to-[#A7D3F3] text-white px-10 py-4 rounded-full font-semibold text-lg shadow-xl"
                >
                  Book Consultation
                </motion.button>
              </Link>
            ...
            >
              <div className="grid grid-cols-2 gap-4">
                {[1, 2, 3, 4].map((item) => (
                  <motion.div
                    key={item}
                    whileHover={{ scale: 1.05, rotate: item % 2 === 0 ? 5 : -5 }}
                    className="aspect-square bg-gradient-to-br from-[#F7C6D3]/20 to-[#A7D3F3]/20 rounded-3xl overflow-hidden shadow-xl flex items-center justify-center"
                  >
                    <Sparkles className="w-16 h-16 text-[#F7C6D3]" />
                  </motion.div>
                ))}
              </div>
            </motion.div>
